...
<head>
    ...
    <title>Add New Entreprise</title>
</head>
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto mt-8">
        ...
        <form action="{{ route('entreprises.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="location" id="location" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Location">
            </div>

            <div class="mb-4">
                <label for="details" class="block text-gray-700 text-sm font-bold mb-2">Details:</label>
                <input type="text" name="details" id="details" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Details">
            </div>
