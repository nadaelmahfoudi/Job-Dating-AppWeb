...
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        ...
        <h1 class="font-semibold text-xl text-gray-800 px-7">Skills</h1>
    ...
    <thead>
        <tr>
        <div class="pull-right">
        <a class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded " href="{{ route('skills.create') }}">
                Create New skill
            </a>
    ...
    <tr>
        ...
        <td class="py-2 px-4 border-b">
            <form action="{{ route('skills.destroy', $skill->id) }}" method="POST" class="flex">
                <a class="btn btn-primary mr-2 bg-blue-700 py-2 px-4 rounded" href="{{ route('skills.edit', $skill->id) }}">Edit</a>
                @csrf
                @method('DELETE')
